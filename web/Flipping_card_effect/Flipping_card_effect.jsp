<%-- 
    Document   : Flipping_card_effect
    Created on : 26/10/2019, 10:21:56 PM
    Author     : Luis Mateos
--%>
...
<html lang="en">
    <head>
        ...
        <!-- Estilos principales -->
        <link href="../lib/css/Flippiing_card_effect/Flipping_card_effect.css" rel="stylesheet" type="text/css"/>
